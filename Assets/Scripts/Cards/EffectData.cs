...
public class EffectData : ScriptableObject
{
    ...
    public string GetText(int payload, bool damageUpdated, int multiplier, CardEffectTarget cardEffectTarget)
    {
        // Add payload
        ...
        if (text.Contains("["))
        {
            ...
            currText = cardEffectTarget == CardEffectTarget.Player
